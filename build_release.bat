...
echo ========================================
echo.
echo GRC2 Modding Build Script (Release)
echo.
echo ========================================
echo.
...
set "SOURCE_DLL=%SOURCE_ROOT%\%PROJECT_DIR%\bin\Release\net472\%DLL_NAME%"
...
"!MSBUILD_PATH!" "!SOLUTION_PATH!" /p:Configuration=Release /p:Platform="Any CPU" /p:GamePath="!GAME_PATH!" /t:Restore /v:minimal /nologo

:: Build project
echo [INFO] Building project...
"!MSBUILD_PATH!" "!SOLUTION_PATH!" /p:Configuration=Release /p:Platform="Any CPU" /p:GamePath="!GAME_PATH!" /t:Build /v:minimal /nologo
